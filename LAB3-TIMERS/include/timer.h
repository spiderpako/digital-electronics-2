...
#define TIM0_STOP      TCCR0B &= ~((1<<CS02) | (1<<CS01) | (1<<CS00)); /* Timer/Counter0
...
#define TIM2_STOP      TCCR2B &= ~((1<<CS22) | (1<<CS21) | (1<<CS20)); /* Timer/Counter2
...
#define TIM0_OVF_ENABLE  TIMSK1 |= (1<<TOIE0);
/** @brief Disable overflow interrupt, 0 --> disable */
#define TIM0_OVF_DISABLE TIMSK1 &= ~(1<<TOIE0);
